...
#include "vtkMaximizeNormalizedShapeIndexProjectionFilter.h"
...
vtkStandardNewMacro(vtkMaximizeNormalizedShapeIndexProjectionFilter)

vtkMaximizeNormalizedShapeIndexProjectionFilter::vtkMaximizeNormalizedShapeIndexProjectionFilter()
{
  this->SetNumberOfOutputPorts(2);
  this->Percentile = 0.95;
  this->RetainLowestValues = 0;
  this->MaximumEdgeLength = 0.25;
  this->Internal = new vtkMaximizeNormalizedShapeIndexProjectionFilterInternal();
}
...
int vtkMaximizeNormalizedShapeIndexProjectionFilter::FillInputPortInformation(
...
double getScore(
  ...
  triangleFilter->SetInputConnection( smoothPolyDataFilter->GetOutputPort() );
  ...
  return massProperties->GetNormalizedShapeIndex();
}


int vtkMaximizeNormalizedShapeIndexProjectionFilter::RequestData(
