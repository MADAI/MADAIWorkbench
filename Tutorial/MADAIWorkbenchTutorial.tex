...
\begin{figure}[htbp]
   ...
   \caption{Collapsed hierarchy of the converted OSCAR1997A file. Each frame is a different time step.}
...
Now open the \texttt{e160\_b7\_3e0\_coarse\_truncated.xmf} file in the MADAI Workbench. 
